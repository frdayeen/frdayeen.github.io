...
<p>
    ...
    <ul>
     ...
     <li className="header">Analyzing the property of insoluble monolayers at physiological temperature using GIXD (Grazing incident X-ray diffraction).</li>
	<li>The primary goals of this research will be elucidating the role of individual molecules in pulmonary surfactant, their cooperation at the molecular scale required for proper lung function, and the design of synthetic surfactant mimics. </li>
    </ul>
   </div> 
   ...
   <div className="row">
    <ul>
     ...
     <li className="header">Building a computational model to  identify the emerging topics from scientific literature.</li>
  ...
  <div className="row">
    <ul>
     ...
     <li className="header">DFT+U Simulation of LaNiO3 using python and the Vienna Ab initio Simulation Package (VASP).</li>
	<li>We computed the structural property, the correlated electronic structure, and the vacancy energetics of LaNiO3 thin films using computer simulation. In this project Vienna Ab-initio simulation package (VASP) was used to perform the Density Funtional Theory (DFT) plus U calculations on the thin films of LaNiO3.</li>
    </ul>
   </div> 
   ...
   <div className="row">
    <ul>
     ...
     <li className="header">Cause-Effect Pair Detection: A classification based approach.</li>
	<li>We attempted to build a classification based approach to solve the cause-effect pair detection problem and thus addresses the importance of attributing causes to effects which is pervasive in almost every aspects of our daily life involving human reasoning and decision making.</li>
    </ul>
   </div> 
   ...
   <div className="row">
    <ul>
     ...
     <li className="header">Analysis of constraint structure of coupling of vector gauge field to a massive tensor field in presence of pseudoscalar and a scalar mass term</li>
<li className="description">
A thesis submitted on toward the degree of Master of Science in Theoretical Physics by Fazle Rabbi Dayeen
</li>
 
<li>We consider a model in which vector gauge field is coupled directly to an antisymmetric tensor field in presence of a pseudoscalar and a pure scalar mass term and hence calculate the degrees of freedom. </li>
    </ul>
   </div>
   ...
   <div className="row">
    <ul>
     ...
     <li className="header">Generating and visualizing the fractal property of Julia-Mandelbrot set using C++ and Gnuplot.</li>
	<li>The Julia-Mandelbrot set is the one of the famous object in computational physics and modern mathematics. We developed a C++ code that generates and plot the set by iterating a simple function on the points of the complex plane.</li>
    </ul>
   </div>
  
   <h3>Journal &amp; Conference publication </h3>
