...
const TopNav = () => {
  return (
    <header className="w-full px-32 py-8 font-medium flex items-center justify-between">
        <h1 className="font-Montserrat text-2xl font-bold">Fazle Rabbi Dayeen</h1>
        <nav>
            <CustomizedLinks href="/" title="Home"/>
            <CustomizedLinks href="/" title="Curriculum Vitae"/>
            <CustomizedLinks href="/" title="Articles"/>
            <CustomizedLinks href="/" title=" My Journey(Bangla)"/>
        </nav>
        ...
        <nav>
            ...
            <Link href={"/"} className="mr-2" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" className="inline-block icon icon-tabler icon-tabler-brand-youtube-filled hover:text-teal-600 hover:scale-125" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M18 3a5 5 0 0 1 5 5v8a5 5 0 0 1 -5 5h-12a5 5 0 0 1 -5 -5v-8a5 5 0 0 1 5 -5zm-9 6v6a1 1 0 0 0 1.514 .857l5 -3a1 1 0 0 0 0 -1.714l-5 -3a1 1 0 0 0 -1.514 .857z" stroke-width="0" fill="currentColor" /></svg></Link>
